...
def detalle_por_dia(fechas_dia, fechas_mes, fechas_anio, ids_socio, indices_tipo_socio, indices_pase, mes, anio):
    daily_summary = {}
...
def menu_principal(fechas_dia, fechas_mes, fechas_anio, ids_socio, indices_tipo_socio, indices_pase, mes, anio, cant_dias):
    ...
    while opcion != "8":
        ...
        if opcion == "1":
            ...
            detalle_por_dia(fechas_dia, fechas_mes, fechas_anio, ids_socio, indices_tipo_socio, indices_pase, mes, anio)
        elif opcion == "5":
